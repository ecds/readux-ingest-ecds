    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "default_ocr",
                    models.CharField(
                        choices=[("word", "word"), ("line", "line"), ("both", "both")],
                        default="word",
                        max_length=30,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pid",
                    models.CharField(
                        default=uuid.uuid4, max_length=255, serialize=False
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="manifests", to=Collection
                    ),
                ),
                (
                    "image_server",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "format",
                    models.TextField(blank=True, default="text/html", null=True),
                ),
                ("is_structured_data", models.BooleanField(default=False)),
                (
                    "manifest",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to=Manifest
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "canvas",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING, to=Canvas
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.DO_NOTHING, to=Manifest
            ),
        ),
        migrations.CreateModel(
            name="User",
